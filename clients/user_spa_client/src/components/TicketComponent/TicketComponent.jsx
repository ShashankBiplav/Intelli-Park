...
function TicketComponent(props) {
  ...
  const done = () => {
   ...
   return (
     ...
     <div className= {"m-6 w-full lg:w-1/3 rounded-lg shadow-lg bg-green-400"}>
       <div className="p-6 object-cover object-center">
         ...
         {data.isActive?<p className="mb-4 text-base leading-relaxed underline"> YOUR VEHICLE IS PARKED</p>: <p className="mb-4 text-base leading-relaxed">COLLECTED BY: <br/> {data.collectedBy['name']} | {data.collectedBy['phone']}</p>}
